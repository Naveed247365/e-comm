...
const data : Data = {
  ...
  headerMenus: [
    {
      name: "Today's Deals",
      hraf: '/search?tag=todays-deals',
    },
    {
      name: 'New Arrivals',
      hraf: '/search?tag=new-arrivals',
    },
    {
      name: 'Featured Products',
      hraf: '/search?tag=featured',
    },
    {
      name: 'Best Sellers',
      hraf: '/search?tag=best-sellers',
    },
    {
      name: 'Browsing History',
      hraf: '/#browsing-history',
    },
    {
      name: 'Customer Service',
      hraf: '/page/customer-service',
    },
    {
      name: 'About Us',
      hraf: '/page/about-us',
